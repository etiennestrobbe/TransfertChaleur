...
public class JavaWebSocket extends BaseWebSocketHandler {
    ...
    public void onOpen(WebSocketConnection connection) throws Exception {
        ...
        LOGGER.log(Level.FINE, "New Connection => Number of connections : " + this.server.getConnectionCount());
    }

    @Override
    public void onClose(WebSocketConnection connection) throws Exception {
        this.server.removeConnection(connection);
        LOGGER.log(Level.FINE, "Remove Connection => Number of connections : " + this.server.getConnectionCount());
    }

    @Override
    public void onMessage(WebSocketConnection connection, String message) throws Exception {
        LOGGER.log(Level.FINE, "Received new message : " + message); // In this case, nothing to do...
    }
}